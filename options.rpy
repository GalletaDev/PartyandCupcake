...
define config.name = _("🧁Party and cupcake🧁")
...
define build.name = "Partyandcupcake"
...
define config.main_menu_music = "audio/bg_dorkis_tension.ogg"
...
define config.save_directory = "Partyandcupcake-1753805293"
